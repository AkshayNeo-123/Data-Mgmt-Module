...
namespace DataMgmtModule.Api.Controllers
{
    ...
    public class RecipeController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddRecipe([FromBody] RecipeandComponent recipeandComponent)
        {
            ...
            var result = await _mediator.Send(new AddRecipeCommand(recipeandComponent));
            var component = await _mediator.Send(new AddRecipeComponentCommand(result, recipeandComponent));
        ...
        public async Task<IActionResult> UpdateRecipe(int id, RecipeandComponent updateRecipeDto)
        {
            ...
            var result = await _mediator.Send(new UpdateRecipeCommand(id,updateRecipeDto.Recipe));
            var updateComponent = await _mediator.Send(new RecipeComponentUpdateCommand(id, updateRecipeDto));
