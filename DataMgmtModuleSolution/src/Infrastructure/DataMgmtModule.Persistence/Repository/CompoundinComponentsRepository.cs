...
namespace DataMgmtModule.Persistence.Repository
{
    public class CompoundingComponentsRepository : ICompoundingComponentsRepository
    {
        ...
        public async Task<int> AddCompoundingComponents(int compoundingId, CompoundingComponent compoundingComponents)
        {
        ...
        public async Task<int> UpdateCompoundingComponents(int compoundId, CompoundingComponent[] compoundingComponents)
        {
